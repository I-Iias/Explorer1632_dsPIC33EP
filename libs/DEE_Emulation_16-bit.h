...
#define __AUXFLASH  1           // use this for dsPIC33EP
#define FLASH_addr  0x028000    // check if adress is valid for specific controller
#pragma message "check if address is valid for specific controller"
